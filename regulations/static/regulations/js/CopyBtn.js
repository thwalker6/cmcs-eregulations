...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("button", {
    class: normalizeClass(["action-btn", $options.buttonClasses]),
    onClick: _cache[0] || (_cache[0] = (...args) => ($options.handleClick && $options.handleClick(...args))),
    disabled: $options.selected && this.status === 'success'
  }, [
    ($options.selected && this.status === 'success')
      ? (openBlock(), createElementBlock("svg", _hoisted_2$1, _hoisted_5$1))
...
script$1.__file = "components/tooltips/ActionBtn.vue";
...
const _hoisted_1 = { class: "copy-btn-container" };
const _hoisted_2 = ["aria-label"];
const _hoisted_3 = /*#__PURE__*/createBaseVNode("i", { class: "fa fa-link" }, null, -1 /* HOISTED */);
const _hoisted_4 = { key: 0 };
const _hoisted_5 = { class: "hover-msg" };
...
const _hoisted_8 = { class: "citation-title" };
const _hoisted_9 = { class: "action-btns" };

function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_ActionBtn = resolveComponent("ActionBtn");
  const _directive_clickaway = resolveDirective("clickaway");

  return (openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("button", {
      class: normalizeClass(["copy-btn text-btn", $options.buttonClasses]),
      "aria-label": $options.ariaLabel,
      onFocus: _cache[0] || (_cache[0] = (...args) => ($options.handleEnter && $options.handleEnter(...args))),
      onFocusout: _cache[1] || (_cache[1] = (...args) => ($options.handleExit && $options.handleExit(...args))),
      onMouseenter: _cache[2] || (_cache[2] = (...args) => ($options.handleEnter && $options.handleEnter(...args))),
      onMouseleave: _cache[3] || (_cache[3] = (...args) => ($options.handleExit && $options.handleExit(...args))),
      onClick: _cache[4] || (_cache[4] = (...args) => ($options.handleClick && $options.handleClick(...args)))
    }, [
      _hoisted_3,
      ($props.btn_type === 'labeled-icon')
        ? (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString($data.label), 1 /* TEXT */))
        : createCommentVNode("v-if", true)
    ], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_2),
    withDirectives(createBaseVNode("div", {
      class: normalizeClass(["copy-tooltip hovered", $options.tooltipClasses]),
      style: normalizeStyle($options.tooltipStyles)
    }, [
      createBaseVNode("p", _hoisted_5, toDisplayString($data.label), 1 /* TEXT */)
    ], 6 /* CLASS, STYLE */), [
      [vShow, $data.entered && $props.btn_type === 'icon']
    ]),
    ($data.clicked)
      ? withDirectives((openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(["copy-tooltip clicked", $options.tooltipClasses]),
          style: normalizeStyle($options.tooltipStyles)
        }, [
          createBaseVNode("button", {
            class: "close-btn text-btn",
            "aria-label": "close copy link or citation dialog",
            onClick: _cache[5] || (_cache[5] = (...args) => ($options.handleCloseClick && $options.handleCloseClick(...args)))
          }, _hoisted_7),
          createBaseVNode("p", _hoisted_8, toDisplayString(this.formatted_citation), 1 /* TEXT */),
          createBaseVNode("div", _hoisted_9, [
            createVNode(_component_ActionBtn, {
              onActionBtnClick: $options.handleActionClick,
              selectedAction: $data.selectedAction,
              status: $data.copyStatus,
              actionType: "link"
            }, null, 8 /* PROPS */, ["onActionBtnClick", "selectedAction", "status"]),
            createVNode(_component_ActionBtn, {
              onActionBtnClick: $options.handleActionClick,
              selectedAction: $data.selectedAction,
              status: $data.copyStatus,
          ...
          [_directive_clickaway, $options.handleCloseClick]
        ])
      : createCommentVNode("v-if", true)
  ]))
}
...
script.__file = "components/tooltips/CopyBtn.vue";
