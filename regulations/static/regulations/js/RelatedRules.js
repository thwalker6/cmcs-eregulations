...
const _hoisted_1$5 = { class: "related-rule recent-change" };
const _hoisted_2$3 = ["href"];
const _hoisted_3$2 = { class: "link-heading" };
const _hoisted_4$1 = {
  key: 0,
  class: "recent-date"
};
const _hoisted_5 = /*#__PURE__*/createTextVNode(" | ");
const _hoisted_6 = { class: "recent-fr" };
const _hoisted_7 = { class: "recent-title" };
    ...
    createBaseVNode("a", {
      ...
      createBaseVNode("span", _hoisted_3$2, [
        createBaseVNode("span", {
          class: normalizeClass($options.getClassList)
        }, toDisplayString($options.expandedType), 3 /* TEXT, CLASS */),
        ($props.publication_date)
          ? (openBlock(), createElementBlock("span", _hoisted_4$1, toDisplayString($props.publication_date | _ctx.formatDate), 1 /* TEXT */))
          : createCommentVNode("v-if", true),
        _hoisted_5,
        createBaseVNode("span", _hoisted_6, toDisplayString($props.citation), 1 /* TEXT */)
      ]),
      createBaseVNode("div", _hoisted_7, toDisplayString($props.title), 1 /* TEXT */)
    ], 8 /* PROPS */, _hoisted_2$3)
  ]))
}

script$5.render = render$5;
script$5.__file = "components/RelatedRule.vue";
...
const _hoisted_1$4 = { class: "show-more-button" };
...
script$4.__file = "components/ShowMoreButton.vue";
...
const _hoisted_1$3 = ["data-test", "aria-label"];
const _hoisted_2$2 = /*#__PURE__*/createTextVNode("Hide");
const _hoisted_3$1 = /*#__PURE__*/createTextVNode("Show");
const _hoisted_4 = /*#__PURE__*/createTextVNode("Click here");
...
script$3.__file = "components/CollapseButton.vue";
...
script$2.__file = "components/Collapsible.vue";

var script$1 = {
    name: "related-rule-list",

    components: {
        RelatedRule: script$5,
        ShowMoreButton: script$4,
        CollapseButton: script$3,
        Collapsible: script$2,
    },
...
const _hoisted_1$1 = {
  key: 0,
  class: "related-rule-list"
};
const _hoisted_2$1 = {
  key: 1,
  class: "show-more-inactive"
};

function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_related_rule = resolveComponent("related-rule");
  ...
  return ($props.rules.length)
    ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($options.limitedRules, (rule, index) => {
          return (openBlock(), createBlock(_component_related_rule, {
            key: index,
            title: rule.title,
            type: rule.type,
            ...
            action: rule.action
          }, null, 8 /* PROPS */, ["title", "type", "citation", "publication_date", "document_number", "html_url", "action"]))
        }), 128 /* KEYED_FRAGMENT */)),
        ($options.showMoreNeeded && $options.rulesCount > 10)
          ? (openBlock(), createBlock(_component_collapse_button, {
              key: 0,
              class: normalizeClass([{ subcategory: _ctx.subcategory }, "category-title"]),
              name: $data.innerName,
              state: "collapsed"
            }, {
              expanded: withCtx(() => [
        ...
        createVNode(_component_collapsible, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList($options.additionalRules, (rule, index) => {
              return (openBlock(), createBlock(_component_related_rule, {
                key: index,
                title: rule.title,
                type: rule.type,
            ...
            ($options.showMoreNeeded && $options.rulesCount > 0)
              ? (openBlock(), createBlock(_component_collapse_button, {
                  key: 0,
                  class: normalizeClass([{ subcategory: _ctx.subcategory }, "category-title"]),
                  name: $data.innerName,
    ...
    : (openBlock(), createElementBlock("div", _hoisted_2$1, " No " + toDisplayString($props.title) + " found in the Federal Register from 1994 to present. ", 1 /* TEXT */))
}

script$1.render = render$1;
script$1.__file = "components/RelatedRuleList.vue";

var script = {
    components: {
      Collapsible: script$2,
      RelatedRuleList: script$1,
      CollapseButton: script$3,
    },
...
const _hoisted_2 = /*#__PURE__*/createBaseVNode("i", { class: "fa fa-chevron-up category-toggle" }, null, -1 /* HOISTED */);
const _hoisted_3 = /*#__PURE__*/createBaseVNode("i", { class: "fa fa-chevron-down category-toggle" }, null, -1 /* HOISTED */);

function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_collapse_button = resolveComponent("collapse-button");
  const _component_related_rule_list = resolveComponent("related-rule-list");
  const _component_collapsible = resolveComponent("collapsible");

  return (openBlock(), createElementBlock("div", null, [
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.categoryList, (category) => {
      return (openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1, [
          createVNode(_component_collapse_button, {
            class: normalizeClass([{ category: category }, "related-rules-title"]),
            name: category,
            state: "collapsed"
          }, {
            expanded: withCtx(() => [
              createTextVNode(toDisplayString($props.categories[category].title) + " ", 1 /* TEXT */),
              _hoisted_2
            ]),
            collapsed: withCtx(() => [
              createTextVNode(toDisplayString($props.categories[category].title) + " ", 1 /* TEXT */),
          ...
          createVNode(_component_collapsible, {
            name: category,
            state: $props.activeCategory === category ? 'expanded':'collapsed'
          }, {
            default: withCtx(() => [
              createVNode(_component_related_rule_list, {
                rules: $options.getRules(category),
                limit: $props.limit,
                title: $props.categories[category].title
              }, null, 8 /* PROPS */, ["rules", "limit", "title"])
            ]),
            _: 2 /* DYNAMIC */
          }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["name", "state"])
        ])
      ]))
...
script.__file = "components/RelatedRules.vue";
